 ...
 * Trash topic action.
 */
class trash_lock extends trash
{
	...
	{
		return (bool) $this->auth->acl_gets(array('m_softdelete', 'm_lock'), $forum_id) || $this->auth->acl_gets(array('m_softdelete', 'f_user_lock'), $forum_id);
	}
